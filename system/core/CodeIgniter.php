 ...
 */
	...
	if ( ! file_exists(APPPATH.'modules/'.$RTR->fetch_class().'/controller/'.$RTR->fetch_directory().$RTR->fetch_class().'.php'))
	{
		show_error('Unable to load your default controller. Please make sure the controller specified in your Routes.php file is valid.');
	}

	include(APPPATH.'modules/'.$RTR->fetch_class().'/controller/'.$RTR->fetch_directory().$RTR->fetch_class().'.php');
 ...
 */
		...
		)
	{
		if ( ! empty($RTR->routes['404_override']))
		{
			...
			if ( ! class_exists($class))
			{
				if ( ! file_exists(APPPATH.'modules/'.$class.'/controller/'.$class.'.php'))
				{
					show_404("{$class}/{$method}");
				}

				include_once(APPPATH.'modules/'.$class.'/controller/'.$class.'.php');
			}
		}
		else
		{
 ...
 */
	...
	{
		$content = $CI->_remap($method, array_slice($URI->rsegments, 2));
	}
	else
	{
